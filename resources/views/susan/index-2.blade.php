...
<html lang="en">
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="#home">Home - teste</a></li>
                            ...
                            <!--<li class="dropdown submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="blog-list-2.html">Blog List Two</a></li>
        ...
        <section class="clients_feedback_area purple_clients" id="feedback">
            <div class="container">
                <div class="main_title purple_title">
        ...
        <!--================Detail Area =================-->
        <section class="detail_doc_area purple_detail">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="left_detail_content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis no trud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                            <a class="read_more purple_read" href="#">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="pricing_item">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Clean and Modern Design</a></li>
                                <li><a href="#">Simple and Professional</a></li>
                                <li><a href="#">24/7 Support</a></li>
                            </ul>
                            <a class="purchase_btn purple_pruchase" href="#">Purchase Now</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pricing_item">
        ...
        <!--================Download Area =================-->
        <section class="download_area purple_dd" id="download">
            <div class="container">
        ...
        <!--================Asked Question Area =================-->
        <section class="asked_question_area">
            <div class="container">
                <div class="content_title_middle purple_content">
                    <h2>Frequently Asked Questions</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis no trud exercitation ullamco laboris.</p>
                </div>
            </div>
                        ...
                        <div class="panel-group" id="askquestion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                ...
                                <div id="question1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="questions1">
                                    <div class="panel-body">
                                        There are many variations of passages of Lorem Ipsum available, but the majoity have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
        ...
        <!--================Expert Team Area =================-->
        <div class="expert_team_area purple_team" id="team">
            <div class="container">
                <div class="main_title purple_title">
        ...
        <!--================Latest Blog Area =================-->
        <section class="latest_blog_area purple_blog" id="blog">
            <div class="container">
               <div class="main_title purple_title">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="latest_blog_item">
                            ...
                            <a href="#"><h4>Five of the best apps to train your brain</h4></a>
                            <h5>Posted by <a href="#">admin</a>  at <a href="#">04 May, 2017</a></h5>
                            ...
                            <div class="contact_form_left">
                                <div class="row">
                                    <form class="comment_form_inner" action="contact_process.php" method="post" id="contactForm">
                                        ...
                                        <div class="form-group col-md-12">
                                            <button class="btn btn-default submit_btn purple_submit" type="submit">Send</button>
                                        </div>
                                    </form>
                                    <div id="success">
                        ...
                        <div class="col-md-6">
                            <div class="contact_details">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Our Location</h4>
                                        <h5>121 King Street, Melbourne, Australia</h5>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
